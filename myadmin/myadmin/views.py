...
def external(request):
    ...
    out= subprocess.run([sys.executable,'C://Users//manish1//Downloads//djangoproj//test.py'],shell=False,stdout=PIPE)
    #print(out)
...
def jiratest(request):
    inp= request.POST.get('param')
    out= subprocess.check_output([sys.executable,'C:\\Users\\manish1\\Downloads\\djangoproj\\myadmin\\jiratest1.py'])
